...
export function CreatorManagementForm({
  ...
  const exceedsOnePage = useMemo(() => creatorManagementExceedsOnePage(details), [details]);
  ...
  const fields = (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            disabled={details.additionalServices.length >= ONE_PAGE_LIMITS.creatorServices}
      ...
      <div className="space-y-1.5">
        ...
        />
        <p className="text-xs text-neutral-400 text-right">{details.terms.length} / {ONE_PAGE_LIMITS.creatorTermsChars} characters</p>
      </div>
